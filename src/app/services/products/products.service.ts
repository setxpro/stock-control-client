...
export class ProductsService {
  ...
  createProduct(reqData: CreateProductRequest): Observable<CreateProductResponse> {
    return this.http.post<CreateProductResponse>(`${this.API_URL}/product`, reqData, this.httpOptions);
  }
}
